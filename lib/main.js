(function() {
  ...
  this.generate = function(me) {
    var _, actual_row, block_count, center, cid, col, dx, dy, entry, fallback, fallback_count, fallback_source, glyph_count, glyphs, i, j, len, local_glyph_count, local_max_cid, local_min_cid, match, max_cid, max_cid_hex, min_cid, min_cid_hex, parser, path, path_count, paths, prefix, ref, ref1, row, selector, source, svgfont, transform, x, y;
    glyphs = {};
    glyph_count = 0;
...
//.........................................................................................................
    for (cid = j = ref = min_cid, ref1 = max_cid; (ref <= ref1 ? j <= ref1 : j >= ref1); cid = ref <= ref1 ? ++j : --j) {
      if (glyphs[cid] == null) {
