  ...
  this.Svgttf2 = (function() {
    class Svgttf2 {
      ...
      glyf_pathdata_from_svg(cfg) {
        var R, bbox, entry/* TAINT add to cfg */, g_dom, g_id, i, j, k, len, len1, len2, path_dom, path_id, pd, pds, project, ref, ref1, ref2, ref3, ref4, seen_pathdoms, svg_dom, sym_name/* TAINT add to cfg */;
        ...
        for (i = 0, len = ref.length; i < len; i++) {
          ...
          if (((ref2 = (ref3 = entry.shift) != null ? ref3.x : void 0) != null ? ref2 : 0) !== 0) {
            entry.pd = this._shift_pathdata(entry.pd, entry.shift);
          }
        }
        ref4 = svg_dom.querySelectorAll('path');
        //.......................................................................................................
