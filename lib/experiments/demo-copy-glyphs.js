(function() {
  ...
  //-----------------------------------------------------------------------------------------------------------
  this.demo = function() {
    var filepath, font, fonts_home, glyph, i, idx, j, k, key, keys, len, len1, ref, ref1, ref2, results;
    ...
    for (j = 0, len1 = ref.length; j < len1; j++) {
      ...
      results.push(debug(`${glyph.index} ${(ref1 = glyph.name) != null ? ref1 : './.'} 0x${((ref2 = glyph.unicode) != null ? ref2 : 0).toString(16)} ${glyph.unicodes}`));
    }
    return results;
  };
