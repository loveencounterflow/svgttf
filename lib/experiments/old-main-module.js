(function() {
  ...
  this.generate = function(me) {
    /* !!!!!!!!!!!!!!!!!!!!!!!!!! */
    var _, center, cid, col, dx, dy, entry, fallback, fallback_count, fallback_source, glyph_count, glyphs, i, len, local_glyph_count, local_max_cid, local_min_cid, match, max_cid, min_cid, parser, path, path_count, path_data, paths, row, selector, source, svg_path/* safeguard against (meaningless, but legal) empty paths */, svgfont, transform, x, y;
    glyphs = {};
    glyph_count = 0;
...
//.......................................................................................................
    for (i = 0, len = paths.length; i < len; i++) {
      ...
      col = Math.floor((center[0] - me.x0) / me.module);
      row = Math.floor((center[1] - me.y0) / me.module);
      dx = -(col * me.module);
      dy = -(row * me.module);
      // .translate  0, 64.9 ### TAINT magic number, equals ( me.module * 2 - 7.1 ) for some reason ###
      svg_path = svg_path.translate(dx, dy).scale(1, -1).translate(0, 28.9).scale(me.scale).round(0);
      cid = 0x4e00 + (modulo(col, 16)) + (row * 16);
      if (!/* TAINT magic number 16: glyphs per row */isa.number(cid)) {
  ...
  this.points_from_absolute_path = function(path) {
    var R, command, i, idx, j, k, l, last_x, last_y, len, m, node, ref, ref1, ref2, ref3, ref4, x, xy, y;
    R = [];
    ref = path['segments'];
    //.........................................................................................................
    for (i = 0, len = ref.length; i < len; i++) {
      ...
      switch (command) {
        ...
        //.....................................................................................................
        case 'Q':
          for (idx = m = 0, ref4 = xy.length; m < ref4; idx = m += +4) {
            [x, y] = [xy[idx + 2], xy[idx + 3]];
            R.push([x, y]);
          }
          break;
...
//# sourceMappingURL=old-main-module.js.map